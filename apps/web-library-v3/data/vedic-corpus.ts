...
export const sampleVerse: Verse = {
  ...
  summary: {
    ...
    gu: 'કર્મ પર ધ્યાન આપો, ફળ પર નહીં',
    or: 'କର୍ମ ଉପରେ ଧ୍ୟାନ ଦିଅନ୍ତୁ, ଫଳ ଉପରେ ନୁହେଁ',
    kn: 'ಕರ್ಮದ ಮೇಲೆ ಗಮನಹರಿಸಿ, ಫಲದ ಮೇಲಲ್ಲ',
    te: 'కర్మపై దృష్టి పెట్టండి, ఫలితంపై కాదు'
  },
  ...
  translations: {
    ...
    te: 'నీకు కర్మ చేయుటకే అధికారము కలదు, కానీ దాని ఫలములపై కాదు. కర్మ ఫలమునకు కారణము కాకుము, మరియు అకర్మ యందు నీకు ఆసక్తి ఉండకూడదు.',
    gu: 'તારો અધિકાર માત્ર કર્મ કરવામાં જ છે, તેના ફળમાં ક્યારેય નહીં. કર્મોના ફળનો હેતુ ન બન અને તારી આસક્તિ અકર્મમાં ન હોય.',
    or: 'ତୁମର ଅଧିକାର କେବଳ କର୍ମ କରିବାରେ ଅଛି, କିନ୍ତୁ ଏହାର ଫଳରେ କଦାପି ନୁହେଁ | କର୍ମର ଫଳର କାରଣ ହୁଅ ନାହିଁ ଏବଂ ଅକର୍ମରେ ତୁମର ଆସକ୍ତି ନହେଉ |',
    kn: 'ನಿನಗೆ ಕರ್ಮ ಮಾಡಲು ಮಾತ್ರ ಅಧಿಕಾರವಿದೆ, ಆದರೆ ಅದರ ಫಲಗಳ ಮೇಲಲ್ಲ. ಕರ್ಮದ ಫಲಕ್ಕೆ ನೀನು ಕಾರಣನಾಗಬೇಡ ಮತ್ತು ಅಕರ್ಮದಲ್ಲಿ ನಿನಗೆ ಆಸಕ್ತಿಯಿರದಿರಲಿ.'
  },
  commentaries: [
    {
      sampradaya: 'general',
      ...
      content: {
        ...
        bn: 'এই শ্লোকটি ভগবদ্গীতার সবচেয়ে বিখ্যাত এবং প্রায়শই উদ্ধৃত শ্লোকগুলির মধ্যে একটি। এটি কর্মযোগের সারমর্মকে ধারণ করে - निःস্বার্থ কর্মের পথ।',
        mr: 'हा श्लोक भगवद्गीतेतील सर्वात प्रसिद्ध आणि वारंवार उद्धृत केलेल्या श्लोकांपैकी एक आहे. हे कर्मयोगाचे सार दर्शवते - निष्काम कर्माचा मार्ग.',
        gu: 'આ શ્લોક ભગવદ ગીતાના સૌથી પ્રખ્યાત અને વારંવાર ટાંકવામાં આવતા શ્લોકોમાંનો એક છે. તે કર્મયોગના સારને સમાવે છે - નિઃસ્વાર્થ કર્મનો માર્ગ.',
        or: 'ଏହି ଶ୍ଳୋକଟି ଭଗବଦ୍ ଗୀତାର ଅନ୍ୟତମ ପ୍ରସିଦ୍ଧ ଏବଂ ଉଦ୍ଧୃତ ଶ୍ଳୋକ | ଏହା କର୍ମ ଯୋଗର ସାରମର୍ମକୁ ଅନ୍ତର୍ଭୁକ୍ତ କରେ - ନିଃସ୍ୱାର୍ଥପର କର୍ମର ପଥ |',
        kn: 'ಈ ಶ್ಲೋಕವು ಭಗವದ್ಗೀತೆಯ ಅತ್ಯಂತ ಪ್ರಸಿದ್ಧ ಮತ್ತು ಉಲ್ಲೇಖಿಸಲ್ಪಟ್ಟ ಶ್ಲೋಕಗಳಲ್ಲಿ ಒಂದಾಗಿದೆ. ಇದು ಕರ್ಮಯೋಗದ ಸಾರವನ್ನು ಒಳಗೊಂಡಿದೆ - ನಿಸ್ವಾರ್ಥ ಕ್ರಿಯೆಯ ಮಾರ್ಗ.',
        te: 'ఈ శ్లోకం భగవద్గీతలో అత్యంత ప్రసిద్ధమైనది మరియు తరచుగా ఉదహరించబడే శ్లోకాలలో ఒకటి. ఇది కర్మ యోగ సారాన్ని కలిగి ఉంది - నిస్వార్థ కర్మ మార్గం.'
      }
    },
    {
      sampradaya: 'gaudiya',
      ...
      content: {
        ...
        gu: 'ભગવદ ગીતા અહીં ભક્તિ સેવાનું વિજ્ઞાન સ્થાપિત કરે છે.',
        or: 'ଭଗବଦ୍ ଗୀତା ଏଠାରେ ଭକ୍ତି ସେବାର ବିଜ୍ଞାନ ପ୍ରତିଷ୍ଠା କରେ |',
        kn: 'ಭಗವದ್ಗೀತೆಯು ಇಲ್ಲಿ ಭಕ್ತಿ ಸೇವೆಯ ವಿಜ್ಞಾನವನ್ನು ಸ್ಥಾಪಿಸುತ್ತದೆ.',
        te: 'భగవద్గీత ఇక్కడ భక్తి సేవ యొక్క విజ్ఞానాన్ని ఏర్పాటు చేస్తుంది.'
      }
    },
    {
      sampradaya: 'advaita',
      ...
      content: {
        ...
        gu: 'આત્મા શાશ્વત રીતે મુક્ત અને નિષ્ક્રિય છે.',
        or: 'ଆତ୍ମା ​​ଶାଶ୍ୱତ ଭାବରେ ମୁକ୍ତ ଏବଂ ନିଷ୍କ୍ରିୟ |',
        kn: 'ಆತ್ಮವು ಶಾಶ್ವತವಾಗಿ ಮುಕ್ತ ಮತ್ತು ನಿಷ್ಕ್ರಿಯವಾಗಿದೆ.',
        te: 'ఆత్మ శాశ్వతంగా ముಕ್ತమైనది మరియు నిష్క్రియాత్మకమైనది.'
      }
    },
    {
      sampradaya: 'madhva',
      ...
      content: {
        ...
        gu: 'આ શ્લોક શીખવે છે કે સ્વધર્મ મુજબ કર્મ કરતી વખતે તમામ ફળો ભગવાન વિષ્ણુને અર્પણ કરવા જોઈએ.',
        or: 'ଏହି ଶ୍ଳୋକଟି ଶିକ୍ଷା ଦିଏ ଯେ ନିଜର ସ୍ୱଧର୍ମ ଅନୁଯାયୀ କର୍ମ କରୁଥିବାବେଳେ ସମସ୍ତ ଫଳ ଭଗବାନ ବିଷ୍ଣୁଙ୍କୁ ଅର୍ପଣ କରାଯିବା ଉଚିତ |',
        kn: 'ಒಬ್ಬರು ತಮ್ಮ ಸ್ವಧರ್ಮದ ಪ್ರಕಾರ ಕರ್ಮವನ್ನು ಮಾಡುವಾಗ ಎಲ್ಲಾ ಫಲಗಳನ್ನು ಭಗವಾನ್ ವಿಷ್ಣುವಿಗೆ ಅರ್ಪಿಸಬೇಕು ಎಂದು ಈ ಶ್ಲೋಕವು ಕಲಿಸುತ್ತದೆ.',
        te: 'ఒకరు తమ స్వధర్మం ప్రకారం కర్మ చేసేటప్పుడు అన్ని ఫలితాలను భగవంతుడైన విష్ణువుకు అర్పించాలని ఈ శ్లోకం బోధిస్తుంది.'
      }
    },
    {
      ...
      content: {
        ...
        gu: 'સ્વાર્થ વગર નારાયણ પ્રત્યે ભક્તિથી કરવામાં આવેલા કર્મો હૃદયને શુદ્ધ કરે છે અને મોક્ષ તરફ દોરી જાય છે.',
        or: 'ସ୍ୱାର୍ଥପର ଇଚ୍ଛା ବିନା ନାରାୟଣଙ୍କ ପ୍ରତି ଭକ୍ତି ସହିତ କରାଯାଇଥିବା କର୍ମ ହୃଦୟକୁ ପବିତ୍ର କରେ ଏବଂ ମୋକ୍ଷ ଆଡକୁ ନିଏ |',
        kn: 'ಸ್ವಾರ್ಥವಿಲ್ಲದೆ ನಾರಾಯಣನ ಭಕ್ತಿಯಿಂದ ಮಾಡಿದ ಕರ್ಮಗಳು ಹೃದಯವನ್ನು ಶುದ್ಧೀಕರಿಸುತ್ತವೆ ಮತ್ತು ಮೋಕ್ಷಕ್ಕೆ ಕಾರಣವಾಗುತ್ತವೆ.',
        te: 'స్వార్థపూరిత కోరిక లేకుండా నారాయణుని పట్ల భక్తితో చేసే పనులు హృదయాన్ని శుద్ధి చేస్తాయి మరియు మోక్షానికి దారితీస్తాయి.'
      }
    }
  ],
  relations: {
