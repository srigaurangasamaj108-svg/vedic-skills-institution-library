    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:block">
            ...
            <p className="text-[10px] text-muted-foreground leading-tight uppercase tracking-widest font-medium">Knowledge OS</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-xl mx-auto px-4">
        <div className="relative group">
          ...
          <Input
            type="search"
            placeholder={`Search ${audience === 'scholar' ? 'scholarly bhashyas' : 'verses and topics'}...`}
            value={searchQuery}
      ...
      <div className="flex items-center gap-2">
        ...
        <Select value={audience} onValueChange={(v) => setAudience(v as any)}>
          ...
          <SelectContent>
            ...
            <SelectItem value="non-devotee">Non-Devotee</SelectItem>
